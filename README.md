...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/partsegdata-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15151&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/partsegdata-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `partsegdata` can be installed with:

```
conda install partsegdata
```

It is possible to list all of the versions of `partsegdata` available on your platform with:
